            ...
            <div className={css(styles.row)}>
              ...
              <div className={css(styles.column)} style={{'paddingLeft':'15px', 'borderLeft':'1px dashed #777'}}>
                ...
                <El nightMode={nightMode}
                    ...
                    &nbsp;Currently most altcoins can only be purchased using Bitcoin/Ethereum, and are seldom available by dollar-to-cryptocurrency vendors. Thus you will first need a traditional Dollar-to-Bitcoin broker such as <a href="https://www.coinbase.com/join/59d710a13d5d8000d2267f0c" className={css(styles.a, styles.boldedColor, nightMode && styles.nightBoldedColor)} target="_blank">Coinbase</a> to trade dollars for BTC/LTC, which you will send to your Binance account.<br /><br />
                    Then, using your Binance account, you would trade BTC for any altcoin you desire. We prefer Binance as they have one of the largest, if not the largest, selections of altcoins available, and immediately pay out coin-fork distributions when they are announced (similar to dividends for the stock market); other brokers have been known to keep these distributions to themselves. They also have some of the lowest, if not the lowest fees, at 0.5%!<br /><br />
